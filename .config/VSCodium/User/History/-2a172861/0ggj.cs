...
enum CameraMode{
    ...
    public class GestorJuego : MonoBehaviour
    {
        ...
        private void DespawnRata()
        {
            ...
            DestroyImmediate(rataGO.transform.GetChild(0).gameObject); 
        ...
        public void SetNewNumRatas(GameObject inputField)
        {
            string numRats = inputField.GetComponent<TMP_InputField>().text;
            if(numRats != null)
                newNumRats = int.Parse(numRats);
        }
    }
}
