...
namespace UCM.IAV.Movimiento
{
 ...
 // Start is called before the first frame update
        ...
        public override ComportamientoDireccion GetComportamientoDireccion()
        {
            int actnumRats = 0;
            prioridad = 3;
             List<TuComponente> listaHijos = new List<TuComponente>();
            ...
            Transform[] auxArray = ratasArray.GetComponentsInChildren<Transform>();
            print(auxArray.Count());
            foreach(Transform t in auxArray){
