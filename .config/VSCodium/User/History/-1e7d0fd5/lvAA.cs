...
public class TargetListControllerCmp : MonoBehaviour
{
    ...
    public GameObject GetTargetNPCDis()=> _targetNPC;
    public GameObject GetTargetEnemyDis()=> _targetEnemy;
    public GameObject GetTargetWeaponDis()=> _targetWeapon;
    public GameObject GetTargetHealthDis()=> _targetHealth;
