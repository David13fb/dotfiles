    ...
    private void updateLists()
    {
        ...
        foreach (Collider auxcol in cols)
        {
            ...
            else if (auxcol.gameObject.layer == LayerMask.NameToLayer("WeaponPickUp"))
            {
                ...
                if(_weapons.HasWeapon(auxcol.gameObject.GetComponent<WeaponPickup>().WeaponPrefab) ==null && !weaponList.Contains(auxcol.gameObject)) weaponList.Add(auxcol.gameObject);
            }
        }
