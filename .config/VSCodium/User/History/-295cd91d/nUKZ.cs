...
namespace Metroidvania
{
    ...
    public class HealthHandler : MonoBehaviour
    {
        ...
        /// </summary>
        public event Action onEntityHealth;

        /// <summary>
        /// Event calls when the entity takesDamage
        /// </summary>
        public event Action onEntityTakesDamage;
        ...
        [SerializeField] private UIHealthController uiHealth;
        ...
        private void UpdateHealth()
        {
            if (currentHealth > maxHealth)
            {
                ...
                if(uiHealth != null) uiHealth.setHealthInBar(currentHealth);
            }
