...
/// </summary>
    public class Agente : MonoBehaviour {
        ...
        public virtual void FixedUpdate()
        {
           ...
           float vMag = cuerpoRigido.linearVelocity.magnitude;
            // Solo limitamos si realmente nos pasamos del máximo Y si la velocidad no es casi cero
                if (vMag > velocidadMax && vMag > 0.0001f)
