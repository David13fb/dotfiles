...
func _ready() -> void:
	talk_dialogue.get_script().set_active(false)
...
func violence() -> void:
	...
	violence_dialogue.get_node().set_active(true)
	pass

func talk() -> void:
	talk_dialogue.get_script().set_active(true)

	violence_dialogue.get_script().set_active(false)
