...
@export var id_init_dialog : String
...
func _ready() -> void:
	violence_dialogue.dialogue_manager.show_dialogue(id_init_dialog);
...
func _on_violence_dialogue_end_violence() -> void:
	...
	if atks == 0:
		print(id_violence_dialog)
		violence_dialogue.show_dialogue(id_violence_dialog)
	if atks == 2:
		#sprite_vic.visible = true
		#sprite_vic.startAnimation()
		print("")
		violence_dialogue.set_active(true)
		violence_dialogue.show_dialogue(id_end_dialog)
	if atks == 3:
		print("Cambio escena")
	pass # Replace with function body.
