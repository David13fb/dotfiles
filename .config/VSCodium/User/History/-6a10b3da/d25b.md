# Minotaur
Proyecto de videojuego actualizado a la versión **Unity 6000.0.62f2**, diseñado a partir del proyecto **Minotaur-Base** con las ampliaciones e implementaciones propuestas en la práctica 2.
...
* **Scripts**. Todas las clases con el código, incluido el GameManager y otras organizadas en una jerarquía de carpetas.
  ...
  * **CodigoPractica**. Directorio con las clases creadas en la práctica.
...
**Asignado a David Fernández Barrios**
...
**Asignado a David Benito Aller y David Canelada Velasco**
...
**Asignado a David Canelada Velasco**
...
**Asignado a David Benito Aller, David Fernández Barrios y David Canelada Velasco**
