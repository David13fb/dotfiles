...
namespace UCM.IAV.Movimiento
{
    public class GameManager : MonoBehaviour
    {
        ...
        [SerializeField] int numCentinelas = 1;
        [SerializeField] int numPatrulleros = 1;
        [SerializeField] int numSmoothPath = 1;
        ...
        private void FindGO()
        {
            if (SceneManager.GetActiveScene().name == "Menu") // Nombre de escena que habr�a que llevar a una constante
            {
                ...
                labelPat = GameObject.Find("LabelPat").GetComponent<Text>();
                labelCen = GameObject.Find("LabelCen").GetComponent<Text>();
            }
        ...
        public void setNumCen()
        {
            numCentinelas = int.Parse(labelCen.text);
        }

        public void setNumPat()
        {
            numPatrulleros = int.Parse(labelPat.text);
        }

        public void setSmoothPath(TMP_InputField inputField)
        {
            numSmoothPath = int.Parse(inputField.text);
        }

        public int getNumMinosCen()
        {
            return numCentinelas;
        }
        public int getNumMinosPat()
        {
            return numPatrulleros;
        }
        
        public int getNumSmoothPath()
        {
            return numSmoothPath;
        }
